namespace BinDays.Api.Collectors.Collectors.Councils
{
    ...
    /// </summary>
    internal sealed partial class SouthOxfordshireDistrictCouncil : GovUkCollectorBase, ICollector
    {
        /// <inheritdoc/>
        ...
        public GetAddressesResponse GetAddresses(string postcode, ClientSideResponse? clientSideResponse)
        {
            ...
            if (clientSideResponse == null)
            {
                ...
                {
                    RequestId = 1,
                    Url = "https://eform.southoxon.gov.uk/ebase/ufsmain?formid=BINZONE_DESKTOP&SOVA_TAG=SOUTH",
                    Method = "GET",
            ...
            else if (clientSideResponse.RequestId == 1)
            {
                ...
                var fullRedirectUrl = $"https://eform.southoxon.gov.uk/ebase/{relativeLocation}";
            ...
            else if (clientSideResponse.RequestId == 2)
            {
                ...
                {
                    RequestId = 3,
                    Url = $"https://eform.southoxon.gov.uk/ebase/BINZONE_DESKTOP.eb?ebz={ebs}",
                    Method = "POST",
                    Body = requestBody,
                    Headers = new Dictionary<string, string>
                    {
