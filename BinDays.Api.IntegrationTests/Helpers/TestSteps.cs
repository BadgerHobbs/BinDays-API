...
internal static class TestSteps
{
	...
	/// <param name="useImpersonate">When true, council requests are executed with browser impersonation (the dio_impersonate transport). Use for councils behind a Cloudflare TLS-fingerprint challenge.</param>
